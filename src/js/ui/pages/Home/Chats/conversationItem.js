...
export default class ConversationItem extends Component {
    ...
    render() {
        ...
        getConversationPortrait(e.conversation).then((uri) => {
        ...
        let draft = Draft.getConversationDraft(e.conversation);
        let draftText = draft.text ? draft.text : (draft.quotedMessage ? '消息引用' : '');
        if (isElectron()) {
                    ...
                    <div className={clazz(classes.inner,classes.fristchat)}>
                        ...
                        <div className={classes.info}>
                            ...
                            <span
                                ...
                                dangerouslySetInnerHTML={{ __html: draftText ? '[草稿]' + draftText : (e.lastMessage && e.lastMessage.messageContent ? userName + emojiParse(e.lastMessage.messageContent.digest(e.lastMessage)) : '') }} />
                            {e.isSilent ? isSilent : ''}
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div className={classes.inner}>
                                ...
                                <div className={classes.info}>
                                    ...
                                    <span
                                        className={classes.message}
                                        dangerouslySetInnerHTML={{__html: draftText ? '[草稿]' + draftText : (e.lastMessage && e.lastMessage.messageContent ? e.lastMessage.messageContent.digest(e.lastMessage) : '')}}/>
                                    {e.isSilent ? isSilent : ''}
                                </div>
                            </div>
